...
export default function MobileApp() {
  return (
    <div className="flex justify-between items-center bg-primary-brand-color bg-mobile-app rounded-lg text-white">
...
"          </a>
      ...
      <picture className="pt-6"><img src="	https://cdn.getir.com/getirweb-images/common/landing/phoneLanding.png" /></picture>
    </div>
  )
}